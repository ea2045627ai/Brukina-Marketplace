...
,
{ id: 'tech-57', product_name: 'Business Laptop 14 Inch', description: 'Portable business laptop for office work, school, browsing and productivity.', price: 5200.00, category: 'computers', vendor_name: 'Computer Plaza Ghana' },
    { id: 'tech-58', product_name: 'Performance Laptop 15.6 Inch', description: 'High-performance laptop for professional work, creative applications and multitasking.', price: 8900.00, category: 'computers', vendor_name: 'Digital Market Hub' },
    { id: 'tech-59', product_name: 'Gaming Laptop 15.6 Inch', description: 'Performance laptop designed for gaming, graphics and demanding applications.', price: 12500.00, category: 'computers', vendor_name: 'GameTech Ghana' },
    { id: 'tech-60', product_name: 'Laptop 17.3 Inch', description: 'Large-screen laptop for productivity, entertainment and professional work.', price: 7800.00, category: 'computers', vendor_name: 'Computer Plaza Ghana' },
    { id: 'tech-61', product_name: 'Desktop Computer Core i5', description: 'Reliable desktop computer for office, school, business and everyday computing.', price: 4800.00, category: 'computers', vendor_name: 'Accra Computer Centre' },
    { id: 'tech-62', product_name: 'Desktop Computer Core i7', description: 'Powerful desktop workstation for demanding office and professional workloads.', price: 7200.00, category: 'computers', vendor_name: 'Accra Computer Centre' },
    { id: 'tech-63', product_name: 'Mini Desktop PC', description: 'Compact computer for offices, reception desks, schools and home workstations.', price: 3600.00, category: 'computers', vendor_name: 'Digital Market Hub' },
    { id: 'tech-64', product_name: 'All-in-One Desktop 24 Inch', description: 'Space-saving all-in-one computer with integrated display for home and office.', price: 6800.00, category: 'computers', vendor_name: 'Computer Plaza Ghana' },

    { id: 'tech-65', product_name: 'HD Laptop Screen 14 Inch', description: 'Replacement HD laptop display for compatible 14-inch notebook models.', price: 850.00, category: 'screens', vendor_name: 'Laptop Parts Ghana' },
    { id: 'tech-66', product_name: 'Full HD Laptop Screen 15.6 Inch', description: 'Replacement Full HD display panel for compatible 15.6-inch laptops.', price: 1050.00, category: 'screens', vendor_name: 'Laptop Parts Ghana' },
    { id: 'tech-67', product_name: 'Full HD Laptop Screen 17.3 Inch', description: 'Large replacement Full HD display panel for compatible 17.3-inch laptops.', price: 1450.00, category: 'screens', vendor_name: 'Laptop Parts Ghana' },
    { id: 'tech-68', product_name: 'QHD Laptop Screen 15.6 Inch', description: 'High-resolution QHD replacement laptop display for compatible models.', price: 1850.00, category: 'screens', vendor_name: 'Laptop Parts Ghana' },
    { id: 'tech-69', product_name: '4K Laptop Screen 15.6 Inch', description: 'Ultra-high-resolution replacement display for compatible premium laptops.', price: 2650.00, category: 'screens', vendor_name: 'Premium Laptop Parts' },
    { id: 'tech-70', product_name: '24 Inch Full HD Monitor', description: 'Full HD desktop monitor for work, study, business and entertainment.', price: 1450.00, category: 'screens', vendor_name: 'Display World Ghana' },
    { id: 'tech-71', product_name: '27 Inch QHD Monitor', description: 'Sharp QHD monitor for productivity, design and professional applications.', price: 2850.00, category: 'screens', vendor_name: 'Display World Ghana' },
    { id: 'tech-72', product_name: '32 Inch 4K Monitor', description: 'Large 4K display for creative work, business and high-resolution entertainment.', price: 4200.00, category: 'screens', vendor_name: 'Display World Ghana' },
    { id: 'tech-73', product_name: 'Laptop LCD Display Cable', description: 'Replacement internal display cable for compatible laptop screen assemblies.', price: 180.00, category: 'screen-accessories', vendor_name: 'Laptop Parts Ghana' },
    { id: 'tech-74', product_name: 'Laptop Screen Hinges Pair', description: 'Replacement hinge set for compatible laptop display assemblies.', price: 220.00, category: 'screen-accessories', vendor_name: 'Laptop Parts Ghana' },
    { id: 'tech-75', product_name: 'Laptop Display Bezel', description: 'Replacement screen bezel for compatible notebook display assemblies.', price: 260.00, category: 'screen-accessories', vendor_name: 'Laptop Parts Ghana' },

    { id: 'tech-76', product_name: 'Mechanical Gaming Keyboard', description: 'Mechanical keyboard designed for gaming, office work and fast typing.', price: 480.00, category: 'accessories', vendor_name: 'GadgetWorld Ghana' },
    { id: 'tech-77', product_name: 'Wireless Ergonomic Keyboard', description: 'Comfortable wireless keyboard designed for extended office and home use.', price: 360.00, category: 'accessories', vendor_name: 'Northstar Accessories' },
    { id: 'tech-78', product_name: 'Wireless Optical Mouse', description: 'Reliable wireless mouse for laptops, desktops and everyday computing.', price: 150.00, category: 'accessories', vendor_name: 'Northstar Accessories' },
    { id: 'tech-79', product_name: 'Bluetooth Mouse', description: 'Compact Bluetooth mouse for compatible laptops, tablets and computers.', price: 180.00, category: 'accessories', vendor_name: 'GadgetWorld Ghana' },
    { id: 'tech-80', product_name: 'USB-C Docking Station', description: 'Multi-port docking station for expanding laptop connectivity and desktop setups.', price: 650.00, category: 'accessories', vendor_name: 'TechTools Ghana' },
    { id: 'tech-81', product_name: 'USB-C Hub 7-in-1', description: 'Multi-port adapter with USB, HDMI and memory card connectivity.', price: 380.00, category: 'accessories', vendor_name: 'TechTools Ghana' },
    { id: 'tech-82', product_name: 'HDMI Cable 2m', description: 'High-quality HDMI cable for computers, monitors, televisions and projectors.', price: 90.00, category: 'accessories', vendor_name: 'CableHub Ghana' },
    { id: 'tech-83', product_name: 'DisplayPort Cable', description: 'DisplayPort cable for compatible computers and high-resolution monitors.', price: 120.00, category: 'accessories', vendor_name: 'CableHub Ghana' },
    { id: 'tech-84', product_name: 'Laptop Cooling Pad', description: 'USB-powered cooling pad designed to improve laptop airflow during heavy use.', price: 240.00, category: 'accessories', vendor_name: 'Computer Plaza Ghana' },
    { id: 'tech-85', product_name: 'Laptop Stand Adjustable', description: 'Adjustable ergonomic stand for laptops and notebooks.', price: 280.00, category: 'accessories', vendor_name: 'Workspace Accessories' },
    { id: 'tech-86', product_name: 'Laptop Backpack', description: 'Protective computer backpack with compartments for laptop and accessories.', price: 320.00, category: 'accessories', vendor_name: 'Workspace Accessories' },
    { id: 'tech-87', product_name: 'Laptop Sleeve 15.6 Inch', description: 'Protective padded sleeve for compatible 15.6-inch laptops.', price: 160.00, category: 'accessories', vendor_name: 'Workspace Accessories' },

    { id: 'tech-88', product_name: '8GB DDR4 RAM', description: 'Desktop or laptop memory module for compatible systems.', price: 420.00, category: 'components', vendor_name: 'Computer Parts Ghana' },
    { id: 'tech-89', product_name: '16GB DDR4 RAM', description: 'High-capacity DDR4 memory upgrade for compatible computers.', price: 720.00, category: 'components', vendor_name: 'Computer Parts Ghana' },
    { id: 'tech-90', product_name: '500GB SATA SSD', description: 'Fast solid-state storage upgrade for compatible laptops and desktops.', price: 520.00, category: 'storage', vendor_name: 'Computer Parts Ghana' },
    { id: 'tech-91', product_name: '1TB NVMe SSD', description: 'High-speed NVMe storage for compatible modern computers.', price: 980.00, category: 'storage', vendor_name: 'Computer Parts Ghana' },
    { id: 'tech-92', product_name: '2TB External Hard Drive', description: 'Portable external storage for backups, documents, photos and media.', price: 950.00, category: 'storage', vendor_name: 'Digital Market Hub' },
    { id: 'tech-93', product_name: '1TB USB Flash Drive', description: 'Portable high-capacity USB storage for transferring and backing up files.', price: 620.00, category: 'storage', vendor_name: 'GadgetWorld Ghana' },
    { id: 'tech-94', product_name: '128GB Memory Card', description: 'High-capacity memory card for compatible phones, cameras and devices.', price: 180.00, category: 'storage', vendor_name: 'GadgetWorld Ghana' },

    { id: 'tech-95', product_name: 'Laptop Replacement Battery', description: 'Replacement battery for compatible laptop models.', price: 650.00, category: 'laptop-parts', vendor_name: 'Laptop Parts Ghana' },
    { id: 'tech-96', product_name: 'Universal Laptop Charger', description: 'Multi-tip replacement power adapter for compatible laptop models.', price: 420.00, category: 'chargers', vendor_name: 'PowerTech Ghana' },
    { id: 'tech-97', product_name: '65W USB-C Laptop Charger', description: 'USB-C power adapter for compatible laptops, tablets and devices.', price: 380.00, category: 'chargers', vendor_name: 'PowerTech Ghana' },
    { id: 'tech-98', product_name: '100W USB-C Laptop Charger', description: 'High-power USB-C charger for compatible laptops and professional devices.', price: 560.00, category: 'chargers', vendor_name: 'PowerTech Ghana' },
    { id: 'tech-99', product_name: 'Laptop Replacement Keyboard', description: 'Replacement keyboard for compatible notebook models.', price: 420.00, category: 'laptop-parts', vendor_name: 'Laptop Parts Ghana' },
    { id: 'tech-100', product_name: 'Laptop Touchpad Replacement', description: 'Replacement touchpad assembly for compatible notebook computers.', price: 360.00, category: 'laptop-parts', vendor_name: 'Laptop Parts Ghana' },
    { id: 'tech-101', product_name: 'Laptop Cooling Fan', description: 'Replacement cooling fan for compatible laptop models.', price: 280.00, category: 'laptop-parts', vendor_name: 'Laptop Parts Ghana' },

    { id: 'tech-102', product_name: 'Wi-Fi 6 Router', description: 'Modern wireless router for fast home and office connectivity.', price: 780.00, category: 'networking', vendor_name: 'ConnectHub Ghana' },
    { id: 'tech-103', product_name: '4G LTE Router', description: 'Wireless 4G router for internet access using compatible SIM networks.', price: 850.00, category: 'networking', vendor_name: 'ConnectHub Ghana' },
    { id: 'tech-104', product_name: '8-Port Network Switch', description: 'Compact Ethernet switch for connecting computers and network devices.', price: 420.00, category: 'networking', vendor_name: 'ConnectHub Ghana' },
    { id: 'tech-105', product_name: 'USB Wi-Fi Adapter', description: 'Wireless network adapter for compatible desktops and laptops.', price: 140.00, category: 'networking', vendor_name: 'ConnectHub Ghana' },
    { id: 'tech-106', product_name: 'USB Bluetooth Adapter', description: 'Bluetooth connectivity adapter for compatible computers.', price: 110.00, category: 'networking', vendor_name: 'ConnectHub Ghana' },

    { id: 'tech-107', product_name: '1080p USB Webcam', description: 'Full HD webcam for meetings, classes, streaming and video calls.', price: 350.00, category: 'devices', vendor_name: 'Digital Market Hub' },
    { id: 'tech-108', product_name: 'USB Computer Speakers', description: 'Compact powered speakers for desktops and laptops.', price: 220.00, category: 'audio', vendor_name: 'GadgetWorld Ghana' },
    { id: 'tech-109', product_name: 'Noise Cancelling Headset', description: 'Over-ear headset for meetings, calls, music and focused work.', price: 520.00, category: 'audio', vendor_name: 'GadgetWorld Ghana' },
    { id: 'tech-110', product_name: 'USB Microphone', description: 'USB microphone for meetings, recording, streaming and online teaching.', price: 480.00, category: 'audio', vendor_name: 'StudioTech Ghana' },
    { id: 'tech-111', product_name: 'Laser Printer', description: 'Efficient printer for home offices, businesses and document production.', price: 2800.00, category: 'office-devices', vendor_name: 'OfficeTech Ghana' },
    { id: 'tech-112', product_name: 'All-in-One Printer Scanner', description: 'Multi-function printer, scanner and copier for home and office use.', price: 2350.00, category: 'office-devices', vendor_name: 'OfficeTech Ghana' },
    { id: 'tech-113', product_name: 'Portable Projector', description: 'Compact projector for presentations, education and home entertainment.', price: 1850.00, category: 'devices', vendor_name: 'Display World Ghana' },
    { id: 'tech-114', product_name: 'Tablet Keyboard Case', description: 'Protective keyboard case for compatible tablets and mobile workstations.', price: 320.00, category: 'accessories', vendor_name: 'Northstar Accessories' },
    { id: 'tech-115', product_name: 'Universal Tablet Stand', description: 'Adjustable stand for tablets used at home, school or office.', price: 150.00, category: 'accessories', vendor_name: 'Workspace Accessories' },
    { id: 'tech-116', product_name: 'Smartphone Tripod Stand', description: 'Adjustable tripod for phones, video calls, photography and content creation.', price: 220.00, category: 'accessories', vendor_name: 'GadgetWorld Ghana' },
    { id: 'tech-117', product_name: 'USB-C to HDMI Adapter', description: 'Adapter for connecting compatible USB-C devices to HDMI displays.', price: 180.00, category: 'accessories', vendor_name: 'CableHub Ghana' },
    { id: 'tech-118', product_name: 'Laptop Privacy Screen 15.6 Inch', description: 'Privacy filter designed for compatible 15.6-inch laptop displays.', price: 260.00, category: 'screen-accessories', vendor_name: 'Workspace Accessories' },
  ];
