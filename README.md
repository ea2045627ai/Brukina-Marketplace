...
Dispatch health is managed through `dispatch_providers`. Bolt and Yango can be marked unavailable by an admin or trusted server job; the app automatically selects `brukina_backup` and queues a protected `dispatch_requests` record instead.
